...
the single strongest pre-game argument for the opposing side
(bullpen freshness, home park advantage, starter small-sample
upside, or recent form). State in one sentence why your edge
calculation holds despite it. If you cannot construct that
sentence with a specific data point, default to lean or pass.
